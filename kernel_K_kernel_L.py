...
data1 = numpy.loadtxt("input_output_files/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/two_point_correlation_function_R_new_gamma=0.4_delta=0.0001_18000points.txt",float)
data2 = numpy.loadtxt("input_output_files/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/renormalized_density_psi_method_2_epsi=1e-4_gamma=0.4_rho=2.0_soft_edge_18000points_corrected4_iter24.0.txt",float)
...
matplotlib.pyplot.imshow(R, vmin=numpy.amin(R)*100000000, vmax=numpy.amax(R))    # see https://stackoverflow.com/questions/16492830/colorplot-of-2d-array-matplotlib
#matplotlib.pyplot.imshow(R, vmin=None, vmax=None)    # see https://stackoverflow.com/questions/16492830/colorplot-of-2d-array-matplotlib
