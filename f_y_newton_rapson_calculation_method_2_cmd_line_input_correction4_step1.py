...
data1 = numpy.loadtxt("input_output_files/V_eff/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu1_contour_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
data2 = numpy.loadtxt("input_output_files/V_eff/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu2_contour_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
data3 = numpy.loadtxt("input_output_files/V_eff/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu1_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
data4 = numpy.loadtxt("input_output_files/V_eff/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu2_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
contr = numpy.loadtxt("input_output_files/V_eff/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu1_contour_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
f_out=file("input_output_files/V_eff/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/f_y_calculation_newton_rapson_method_2_gamma="+str(gamma)+"_9000points_correction4_iter1.0.txt","w")

#data1 = numpy.loadtxt("input_output_files/V_eff_delta/quad_pot/rho_"+str(rho)+"_delta/gamma_"+str(gamma)+"/contour/nu1_contour_delta_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
#data2 = numpy.loadtxt("input_output_files/V_eff_delta/quad_pot/rho_"+str(rho)+"_delta/gamma_"+str(gamma)+"/contour/nu2_contour_delta_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
#data3 = numpy.loadtxt("input_output_files/V_eff_delta/quad_pot/rho_"+str(rho)+"_delta/gamma_"+str(gamma)+"/mapping/mapping_output_nu1_delta_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
#data4 = numpy.loadtxt("input_output_files/V_eff_delta/quad_pot/rho_"+str(rho)+"_delta/gamma_"+str(gamma)+"/mapping/mapping_output_nu2_delta_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
#contr = numpy.loadtxt("input_output_files/V_eff_delta/quad_pot/rho_"+str(rho)+"_delta/gamma_"+str(gamma)+"/contour/nu1_contour_delta_c1="+str(c1_short)+"_c0="+str(c0_short)+"_9000points_iter1.0.txt",float)
#f_out=file("input_output_files/V_eff_delta/quad_pot/rho_"+str(rho)+"_delta/gamma_"+str(gamma)+"/density/f_y_delta_calculation_newton_rapson_method_2_gamma="+str(gamma)+"_9000points_correction4_iter1.0.txt","w")
