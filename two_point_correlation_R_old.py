...
numpy.savetxt("input_output_files/quad_pot/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/two_point_correlation_function_R_old_gamma="+str(gamma)+"_delta"+str(delta)+"_18000points.txt", R, delimiter = ' ')
